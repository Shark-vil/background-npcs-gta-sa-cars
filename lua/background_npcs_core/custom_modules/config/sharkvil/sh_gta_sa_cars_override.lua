...
civil_defense.vehicles = {
   'simfphys_gta_sa_enforcer',
}

local special_forces = bgNPC.cfg.npcs_template['special_forces']
special_forces.vehicles = {
   'simfphys_gta_sa_swatvan',
}

local special_forces_2 = bgNPC.cfg.npcs_template['special_forces_2']
special_forces_2.vehicles = {
   'simfphys_gta_sa_fbiranch',
   'simfphys_gta_sa_fbitruck'
}